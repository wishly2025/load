document.addEventListener("DOMContentLoaded", () => {
    ...
    if (giftBox) {
        giftBox.addEventListener("click", () => {
            if (!isOpened) {
                ...
                window.location.href = "http://wishly.club/wishly_poon/sixthpage.html"; // Redirect on second click
            }
        });
    }
    ...
    if (revealButton) {
        revealButton.addEventListener("click", () => {
            window.location.href = "http://wishly.club/wishly_poon/thirdpage.html"; // Redirect to next page
        });
    }
